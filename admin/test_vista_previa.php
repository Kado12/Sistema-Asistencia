<?php include 'includes/header_edit.php'; ?>
        ...
        <div class="test-container-1 rounded-4 shadow overflow-hidden mx-auto mb-4" style="max-width: 800px;">
            <form class="test-1 mb-2 letraNavBar">
                ...
                <div class="test-questions d-flex flex-column">
                    ...
                    for ($i = 0; $i < $query->num_rows; $i++) {
                        ...
                        <div class="mx-4 my-3">
                            ...
                            <label style="font-size: 14px;">
                                <input type="radio" name="p<?php echo $i ?>" value="<?php echo $rowPreg['valor_1'] ?>">
                                <?php echo $label_1 ?>
                            </label>
                            <br>
                            <label style="font-size: 14px;">
                    ...
                    <?php } ?>
                    <a href="test-panel.php" style="display:flex ;justify-content: right;"><input type="button" class="btn text-white letraNavBar rounded-pill px-4 ms-auto m-4 mt-2" value="Atras" style="background: #5eb130;"></a>
                </div>
            </form>
        </div>
