          ...
          <div class="col-xs-12">
              ...
              <div class="box-header with-border gestion__seccion">
                <div class="button__gestion">
                  <a href="new-gestion_practicante.php" class="btn btn-primary btn-sm btn-flat ">Gestionar liste de pracicantes</a>
                ...
                <div>
                  ...
                  <a href="new-gestion_rango-auxiliar.php" class="btn btn-sm btn-flat">Auxiliar de gerencia</a>
              ...
              <?php include 'includes/new-gestion_practicante.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="new-gestion_practicante.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog modal-md" role="document">
                            ...
                            <div class="modal-header py-2">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="new-gestion_practicante.php">
                                ...
                                <div class="form-group">
                                    <label for="agregar_notas">Agregar Notas:</label>
                                    <select class="form-control" id="agregar_notas" name="agregar_notas" required>
                                    <option value="Sí" <?php if ($permiso["agregar_notas"] == "Sí") echo "selected"; ?>>Sí</option>
                                    <option value="No" <?php if ($permiso["agregar_notas"] == "No") echo "selected"; ?>>No</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="ver_notas">Ver Notas:</label>
