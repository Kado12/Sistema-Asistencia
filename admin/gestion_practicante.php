  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Gestionar lista de practicantes
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="box">
              <div class="box-header with-border gestion__seccion">
                <div class="button__gestion">
                  ...
                  <a href="gestion_practicante.php" class="btn btn-primary btn-sm btn-flat ">Gestionar liste de pracicantes</a>
              ...
              <?php include 'includes/gestion_practicante.php'; ?>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="gestion_practicante.php">
